...
public class FavouriteItem extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
	...
	public FavouriteItem(@NonNull Context context, @NonNull List<CallObject> incomingCallObjectList) {
		try {
	...
	public FavouriteItem(@NonNull Context context, @NonNull List<CallObject> incomingCallObjectList, boolean readContacts) {
	...
	private boolean showItemMenuDialog (@NonNull Context context, @NonNull CallObject incomingCallObject, @NonNull String correspondent) {
		...
		CharSequence[] menuItems = {incomingCallObject.isFavourit () ? resources.getString(R.string.txt_unfavourite) :resources.getString(R.string.txt_favou) , resources.getString(R.string.txt_open_call_recorder) , resources.getString(R.string.txt_delete) };		Drawable drawable;
		String stitle = "";
		if (incomingCallObject.getType ().equals ("incoming")) {
			drawable = ResourceUtil.getDrawable (context, R.drawable.img_inoming);
			stitle =resources.getString(R.string.txt_incoming_call);
		} else {
			drawable = ResourceUtil.getDrawable (context, R.drawable.img_outgoing);
			stitle = resources.getString(R.string.txt_outgoing_call);
		}
