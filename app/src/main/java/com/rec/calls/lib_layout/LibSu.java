...
public class LibSu extends FrameLayout {
	...
	public LibSu(Context context) {
		this (context, null);
	}


	public LibSu(Context context, @Nullable AttributeSet attrs) {
		this (context, attrs, 0);
	}


	public LibSu(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
